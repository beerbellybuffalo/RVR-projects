...
3. bothservo.py MUST be run via Terminal on the RPi (I had python3.7)
...
FYI
The script bothservo.py is based off the Keyboard Control script at: https://sdk.sphero.com/docs/samples_content/raspberry_pi/python/keyboard_control_sample/
